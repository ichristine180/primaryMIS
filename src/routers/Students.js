...
router.get('/students/:levelid',Auth.verifyToken,StudentController.getAllByLevel);
router.get('/students/class/:classid',Auth.verifyToken,StudentController.getAllByClass);

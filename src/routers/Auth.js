...
router.put('/users/delete/:userid',Auth.verifyToken,Auth.isHeadMaster,AuthController.hideuser);
router.get('/users/all',Auth.verifyToken,Auth.isHeadMaster,AuthController.getAll);
router.get('/users/:userid',Auth.verifyToken,Auth.isHeadMaster,AuthController.getById);
router.get('/teachers/',Auth.verifyToken,Auth.isHeadMaster,AuthController.getTeachers);
